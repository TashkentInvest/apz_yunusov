...
class Objectt extends Model
{
    ...
    protected $fillable = [
        ...
        'district_id', 'address', 'cadastre_number', 'work_type', 'construction_volume',
        'above_permit_volume', 'parking_volume', 'technical_rooms_volume',
        'common_area_volume', 'construction_type_id', 'object_type_id',
        'territorial_zone_id', 'location_type', 'additional_info', 'geolocation'
    ];
