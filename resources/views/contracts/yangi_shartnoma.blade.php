...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <form method="GET" action="{{ route('contracts.yangi_shartnoma') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
...
@endif
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            <h3 class="text-lg font-semibold text-gray-900">АРТ(АПЗ) тўлови бўйича шартнома тузилиши лозим бўлган объектлар рўйхати</h3>
        </div>
...
function exportContracts() {
    ...
    window.location.href = `{{ route('contracts.yangi_shartnoma') }}?${params.toString()}`;
}
</script>
@endpush
