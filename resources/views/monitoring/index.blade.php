                ...
                <table class="w-full border-collapse text-xs">
                    <thead class="bg-gray-100">
                        ...
                        <tr>
                            ...
                            <th rowspan="3" class="border border-gray-400 px-3 py-3 text-xs font-bold text-gray-800 min-w-[140px] sticky left-0 bg-gray-100 z-10">Ҳудуд</th>
                            ...
                            <th colspan="6" class="border border-gray-400 px-3 py-3 text-xs font-bold text-gray-800">шундан</th>
                            <th colspan="9" class="border border-gray-400 px-3 py-3 text-xs font-bold text-gray-800">Амалдаги шартномалар</th>
                            <th colspan="6" class="border border-gray-400 px-3 py-3 text-xs font-bold text-gray-800">2025 III чоракда тўланиши лозим бўлган сумма</th>
                            <th colspan="6" class="border border-gray-400 px-3 py-3 text-xs font-bold text-gray-800">2025 йил оҳирига қадар тўланиши лозим бўлган сумма</th>
                            <th colspan="6" class="border border-gray-400 px-3 py-3 text-xs font-bold text-gray-800">2026 йил давомида тўланиши лозим бўлган сумма</th>
                            <th colspan="6" class="border border-gray-400 px-3 py-3 text-xs font-bold text-gray-800">2027 йил давомида тўланиши лозим бўлган сумма</th>
                        </tr>

                        <!-- Second row - Sub Headers -->
                        <tr>
                            <th rowspan="2" class="border border-gray-400 px-2 py-2 text-xs font-semibold text-gray-700">сони</th>
                            <th rowspan="2" class="border border-gray-400 px-2 py-2 text-xs font-semibold text-gray-700">млрд сўм</th>
                            <th colspan="2" class="border border-gray-400 px-2 py-2 text-xs font-semibold text-gray-700">Бекор қилинган</th>
                            <th colspan="2" class="border border-gray-400 px-2 py-2 text-xs font-semibold text-gray-700">Тўлиқ тўланган</th>
                            <th colspan="2" class="border border-gray-400 px-2 py-2 text-xs font-semibold text-gray-700">Амалдаги шартномалар</th>
                            <th colspan="2" class="border border-gray-400 px-2 py-2 text-xs font-semibold text-gray-700">Жами</th>
                            <th colspan="2" class="border border-gray-400 px-2 py-2 text-xs font-semibold text-gray-700">Муддати ўтганлар</th>
                    ...
                    <tbody>
                        ...
                        <tr class="bg-gray-200 font-bold border-t-2 border-b-2 border-gray-500">
                            ...
                            <td class="border border-gray-400 px-3 py-3 text-right">{{ number_format($cityTotals['total_amount'] / 1000000000, 1) }}</td>
                            ...
                            <td class="border border-gray-400 px-3 py-3 text-right">{{ number_format($cityTotals['cancelled_amount'] / 1000000000, 1) }}</td>
                            ...
                            <td class="border border-gray-400 px-3 py-3 text-right">{{ number_format($cityTotals['completed_amount'] / 1000000000, 1) }}</td>
                            <td class="border border-gray-400 px-3 py-3 text-center">{{ $cityTotals['active_count'] }}</td>
                            <td class="border border-gray-400 px-3 py-3 text-right">{{ number_format(($cityTotals['total_amount'] - $cityTotals['cancelled_amount']) / 1000000000, 1) }}</td>
                            <td class="border border-gray-400 px-3 py-3 text-center">{{ $cityTotals['active_count'] }}</td>
                            <td class="border border-gray-400 px-3 py-3 text-right">{{ number_format($cityTotals['total_paid'] / 1000000000, 1) }}</td>
                            <td class="border border-gray-400 px-3 py-3 text-center">{{ $cityTotals['overdue_count'] }}</td>
                            <td class="border border-gray-400 px-3 py-3 text-right">{{ number_format($cityTotals['overdue_amount'] / 1000000000, 1) }}</td>
                            ...
                            <td class="border border-gray-400 px-3 py-3 text-right">{{ number_format($cityTotals['q3_2025_plan_amount'] / 1000000000, 1) }}</td>
                            ...
                            <td class="border border-gray-400 px-3 py-3 text-right">{{ number_format($cityTotals['q3_2025_fact_amount'] / 1000000000, 1) }}</td>
                            <td class="border border-gray-400 px-3 py-3 text-center">{{ $cityTotals['q3_2025_diff_count'] }}</td>
                            <td class="border border-gray-400 px-3 py-3 text-right">{{ number_format($cityTotals['q3_2025_diff_amount'] / 1000000000, 1) }}</td>
                            ...
                            <td class="border border-gray-400 px-3 py-3 text-right">{{ number_format($cityTotals['q4_2025_plan_amount'] / 1000000000, 1) }}</td>
                            ...
                            <td class="border border-gray-400 px-3 py-3 text-right">{{ number_format($cityTotals['q4_2025_fact_amount'] / 1000000000, 1) }}</td>
                            <td class="border border-gray-400 px-3 py-3 text-center">{{ $cityTotals['q4_2025_diff_count'] }}</td>
                            <td class="border border-gray-400 px-3 py-3 text-right">{{ number_format($cityTotals['q4_2025_diff_amount'] / 1000000000, 1) }}</td>
                            ...
                            <td class="border border-gray-400 px-3 py-3 text-right">{{ number_format($cityTotals['y2026_plan_amount'] / 1000000000, 1) }}</td>
                            ...
                            <td class="border border-gray-400 px-3 py-3 text-right">{{ number_format($cityTotals['y2026_fact_amount'] / 1000000000, 1) }}</td>
                            <td class="border border-gray-400 px-3 py-3 text-center">{{ $cityTotals['y2026_diff_count'] }}</td>
                            <td class="border border-gray-400 px-3 py-3 text-right">{{ number_format($cityTotals['y2026_diff_amount'] / 1000000000, 1) }}</td>
                            ...
                            <td class="border border-gray-400 px-3 py-3 text-right">{{ number_format($cityTotals['y2027_plan_amount'] / 1000000000, 1) }}</td>
                            ...
                            <td class="border border-gray-400 px-3 py-3 text-right">{{ number_format($cityTotals['y2027_fact_amount'] / 1000000000, 1) }}</td>
                            <td class="border border-gray-400 px-3 py-3 text-center">{{ $cityTotals['y2027_diff_count'] }}</td>
                            <td class="border border-gray-400 px-3 py-3 text-right">{{ number_format($cityTotals['y2027_diff_amount'] / 1000000000, 1) }}</td>
                        </tr>
                        ...
                        @foreach (array_reverse($monitoringData) as $index => $data)
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="border border-gray-300 px-3 py-2 text-right text-gray-700">{{ number_format($data['total_amount'] / 1000000000, 1) }}</td>
                                ...
                                <td class="border border-gray-300 px-3 py-2 text-right text-gray-700">{{ number_format($data['cancelled_amount'] / 1000000000, 1) }}</td>
                                ...
                                <td class="border border-gray-300 px-3 py-2 text-right text-gray-700">{{ number_format($data['completed_amount'] / 1000000000, 1) }} </td>
                                <td class="border border-gray-300 px-3 py-2 text-center">{{ $data['active_count'] }}</td>
                                <td class="border border-gray-300 px-3 py-2 text-right text-gray-700">{{ number_format(($data['total_amount'] - $data['cancelled_amount']) / 1000000000, 1) }} </td>
                                <td class="border border-gray-300 px-3 py-2 text-center">{{ $data['active_count'] }}</td>
                                <td class="border border-gray-300 px-3 py-2 text-right text-gray-700">{{ number_format($data['total_paid'] / 1000000000, 1) }}</td>
                                <td class="border border-gray-300 px-3 py-2 text-center text-gray-700">{{ $data['overdue_count'] }}</td>
                                <td class="border border-gray-300 px-3 py-2 text-right text-gray-700">{{ number_format($data['overdue_amount'] / 1000000000, 1) }}</td>
                                ...
                                <td class="border border-gray-300 px-3 py-2 text-right text-gray-700">{{ number_format($data['q3_2025_plan_amount'] / 1000000000, 1) }}</td>
                                ...
                                <td class="border border-gray-300 px-3 py-2 text-right text-gray-700">{{ number_format($data['q3_2025_fact_amount'] / 1000000000, 1) }}</td>
                                <td class="border border-gray-300 px-3 py-2 text-center text-gray-700">{{ $data['q3_2025_diff_count'] }}</td>
                                <td class="border border-gray-300 px-3 py-2 text-right text-gray-700">{{ number_format($data['q3_2025_diff_amount'] / 1000000000, 1) }}</td>
                                ...
                                <td class="border border-gray-300 px-3 py-2 text-right text-gray-700">{{ number_format($data['q4_2025_plan_amount'] / 1000000000, 1) }}</td>
                                ...
                                <td class="border border-gray-300 px-3 py-2 text-right text-gray-700">{{ number_format($data['q4_2025_fact_amount'] / 1000000000, 1) }}</td>
                                <td class="border border-gray-300 px-3 py-2 text-center text-gray-700">{{ $data['q4_2025_diff_count'] }}</td>
                                <td class="border border-gray-300 px-3 py-2 text-right text-gray-700">{{ number_format($data['q4_2025_diff_amount'] / 1000000000, 1) }}</td>
                                ...
                                <td class="border border-gray-300 px-3 py-2 text-right text-gray-700">{{ number_format($data['y2026_plan_amount'] / 1000000000, 1) }}</td>
                                ...
                                <td class="border border-gray-300 px-3 py-2 text-right text-gray-700">{{ number_format($data['y2026_fact_amount'] / 1000000000, 1) }}</td>
                                <td class="border border-gray-300 px-3 py-2 text-center text-gray-700">{{ $data['y2026_diff_count'] }}</td>
                                <td class="border border-gray-300 px-3 py-2 text-right text-gray-700">{{ number_format($data['y2026_diff_amount'] / 1000000000, 1) }}</td>
                                ...
                                <td class="border border-gray-300 px-3 py-2 text-right text-gray-700">{{ number_format($data['y2027_plan_amount'] / 1000000000, 1) }}</td>
                                ...
                                <td class="border border-gray-300 px-3 py-2 text-right text-gray-700">{{ number_format($data['y2027_fact_amount'] / 1000000000, 1) }}</td>
                                <td class="border border-gray-300 px-3 py-2 text-center text-gray-700">{{ $data['y2027_diff_count'] }}</td>
                                <td class="border border-gray-300 px-3 py-2 text-right text-gray-700">{{ number_format($data['y2027_diff_amount'] / 1000000000, 1) }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
