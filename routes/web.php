...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('contracts')->name('contracts.')->group(function () {
        ...
        Route::prefix('{contract}')->group(function () {
            ...
            Route::post('/create-amendment', [ContractController::class, 'createAmendment'])->name('create_amendment');
            Route::post('/amendment-preview', [ContractController::class, 'getAmendmentPreview'])->name('amendment_preview');
            Route::get('/amendments', [ContractController::class, 'getAmendments'])->name('amendments');
        });
